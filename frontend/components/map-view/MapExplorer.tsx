...
import { INITIAL_LOCATIONS, MARKER_VARIABLE, NAVIGATION_TABS, EVENTS_DATA } from '@/frontend/lib/map-view-data';
import { LocationItem, EventItem, UserProfile } from '@/frontend/lib/map-view-types';
